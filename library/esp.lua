...
do -- Initalize
    ...
    local ESP = function(plr)
        ...
        -- Health uses one solid threshold color at a time, not a three-color gradient.
        local HealthbarGradient = Functions:Create("UIGradient", {Parent = Healthbar, Enabled = false})
